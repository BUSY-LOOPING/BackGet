...
import com.java.busylooping.backget.CustomRecyclerView.WrapContentLinearLayoutManager;
...
import com.java.busylooping.backget.RecyclerViewAdapters.SingleImageScrollableAdapter;
        ...
        recycleView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                super.onScrolled(recyclerView, dx, dy);
                    ...
                    AppEvent appEvent = new AppEvent(EventDef.Category.CALLBACK, EventDef.CALLBACK_EVENTS.SCROLL_CALLBACK,0,0);
                    appEvent.extras.putInt(POS, pos);
                    appEvent.extras.putString(GlobalAppController.GENERAL_MODEL_ID, list.get(pos).getImageId());
...
//        eventBus(context).post(event);
    ...
    @Override
    public void onUtilsClick(int pos) {
        Bundle bundle = new Bundle();
...
//        ImageDetailFragment.scrollCallback = null;
        ...
        bundle.putString(ProfileFragment.USER, list.get(pos).getProfileModel().getUsername());
        bundle.putSerializable(GlobalAppController.PROFILE_MODEL, list.get(pos).getProfileModel());
...
//    private void showUtilsPopup(FragmentManager fragmentManager, Bundle bundle) {
